const contentLetterSrart_actived = "Happy Birdday My Sister ." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc Chị gái iu sinh nhật vui vẻ,tuổi mới nhiều niềm vui mới, thành công trong cuộc sống và cả công việc💝 " //Nội dung của bức thư
...
let imgLetter = document.querySelector(".jpg");
imgLetter.src = "./img/mphuong.ipg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
